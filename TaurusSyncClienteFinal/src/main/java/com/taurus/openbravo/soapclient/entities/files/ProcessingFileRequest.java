...
public class ProcessingFileRequest  extends com.taurus.openbravo.soapclient.entities.files.ProcessingFileBase  implements java.io.Serializable {
    private com.taurus.openbravo.soapclient.entities.security.CredentialData credentials;

    public ProcessingFileRequest() {
    }
    ...
    /**
     * Gets the credentials value for this ProcessingFileRequest.
     * 
     * @return credentials
     */
    ...
    /**
     * Sets the credentials value for this ProcessingFileRequest.
     * 
     * @param credentials
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProcessingFileRequest)) return false;
        ProcessingFileRequest other = (ProcessingFileRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessingFileRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/GrupoTaurus.Framework.DataSynchronizer.Entities.Files", "ProcessingFileRequest"));
